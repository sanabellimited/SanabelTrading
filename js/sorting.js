	...
	jQuery('.btn_load_more').click(function(){
		...
		if (now_load > 0) {
			if (addon_options.type == 0) {
				...
				for (i = i_start-1; i < i_start+now_load-1; i++) {
					loaded_object = loaded_object + '<div data-category="'+ addon_options.items[i].category +'" class="'+ addon_options.items[i].category +' element added">                                                    	<div class="filter_img"><div class="hover_img"><img src="'+ addon_options.items[i].src +'" alt="" /><a href="'+ addon_options.items[i].zoom_src +'" class="zoom prettyPhoto" rel="prettyPhoto[portfolio1]">Zoom</a></div><div class="portfolio_descr"><div class="portfolio_title"><h4><a href="'+ addon_options.items[i].url +'">'+ addon_options.items[i].title +'</a></h4></div><div class="portfolio_text">'+ addon_options.items[i].description +'</div></div></div></div>';
